...
実際のレビューでは、アプリが接続切れを起こし、再起動を繰り返すはめになるケースがある。NC設定やEQ調整をするたびにアプリが必要だからこそ、この不安定さは実用性に直結する。
...
空間音響技術は普通のイヤホンとは別物で、映画を観るみたいに音が立体的に聞こえる仕上がりだ。

**装着のたびに自動で音質とNCが最適化される**
CustomTune技術について「毎回ちょうど良く調整されている」「手動調整の手間がない」という好評が多い。

**長時間装着でも耳が痛くなりにくい**
シリコンイヤーチップの形状と素材のおかげで、8時間付けっぱなしでも疲れにくい。
