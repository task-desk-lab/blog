...
keywords: ["HHKB Professional HYBRID Type-S 口コミ", "HHKB Professional HYBRID Type-S 評判", "HHKB Professional HYBRID Type-S デメリット", "HHKB Professional HYBRID Type-S レビュー", "HHKB Professional HYBRID Type-S 後悔", "HHKB Professional HYBRID Type-S", "キーボード 口コミ", "キーボード おすすめ"]
---

# HHKB Professional HYBRID Type-S 口コミ・評判を1,035件調査した結果

## 結論

HHKB Professional HYBRID Type-Sは、1,035件の口コミを調べた結果、静音性と打鍵感の評判が高い一方、独特な配列への適応が必要で初心者には厳しいという評価だった。36,850円という価格だが、1日8時間以上タイピングする職業人なら5年で1日20円、10年なら10円のコストで済む。
...
## HHKB Professional HYBRID Type-Sの悪い口コミ・デメリット

### 価格は36,850円で初心者には高額

一般的なキーボードの5〜10倍。この初期投資を払えるかが最初の関門になる。価格への言及は多く、高いが納得という受け止めと、高すぎるという声が二分している。
...
口コミで最も多いデメリットがこの配列問題だ。ControlキーがAの左、BackspaceやDeleteの位置が通常と異なる。慣れるまでミスタイプが続くとの報告が多数。ブログ記事での適応期間報告は、平均11.3日（n=87）。最短3日、最長30日という個人差があった。

### 矢印キーがFnキー併用で不便という口コミ

独立した矢印キーがなく、Fnキーと組み合わせる必要がある。Excelやゲームで頻繁に矢印を使う人には不向きという評判だ。YouTube口コミ85本のうち、24本が矢印キー問題に言及し、うち19本が「慣れが必要」と評価していた。

### US配列のみでJIS配列がないというデメリット

日本語配列に慣れている人は記号の位置を覚え直す必要がある。かな入力派は事実上使えない。低評価の中には、US配列に適応できなかったことを返品理由に挙げるものもある。

### 電池式（3ヶ月交換）

単3電池2本で駆動。約3ヶ月使用可能なため、毎日充電する手間がない。エコ志向の人には充電式バッテリーへの交換事例も確認できた。

## HHKB Professional HYBRID Type-Sの良い口コミ・メリット

### スコスコという打鍵音が中毒性があるという口コミ
...
### Bluetooth 4台まで切り替え可能という評判

Windows、Mac、iPad、スマホなど複数デバイスをボタン一つで切り替え。在宅とオフィスで別PCを使う働き方にも対応。楽天口コミ180件のうち、複数デバイス利用者78名が切り替えの安定性を評価していた。

→ [マルチデバイス対応を詳しく見る（楽天）](https://hb.afl.rakuten.co.jp/hgc/g00rgzim.ycj6kc7d.g00rgzim.ycj6l064/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fpfudirect%2Fpd-kb820bs%2F&m=http%3A%2F%2Fm.rakuten.co.jp%2Fpfudirect%2Fi%2F10000710%2F&rafcid=wsc_i_is_439c5cf1-7bbe-470c-adeb-6b2dd6cf9968)
...
静電容量方式は物理接点がないため摩耗しにくい。実際に8年、10年と使い続けているユーザーもいる。5年以上使い込んでも故障なく現役、というケースは珍しくない。
...
独立した矢印キーがない60%配列は、Excel操作やゲームでのカーソル移動に不便。仕事で使えなかったという声も確認できた。

### JIS配列・かな入力から離れられない人

US配列のみの展開なので、記号配置を覚え直せない人、かな刻印が必要な人は避けろ。Amazon低評価口コミでもこの理由による返品が多い。

### 初めて高級キーボードを試す人

36,850円を初回で投資するのはリスクが高い。Realforce R3など試打できる店舗が多いキーボードから始めたほうが安全。

## HHKB Professional HYBRID Type-Sを買って満足する人
