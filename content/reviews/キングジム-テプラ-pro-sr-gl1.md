...
キングジム テプラ PRO SR-GL1は、Amazon・楽天ともに評価が安定している好評価のラベルライター。ただし弱点は「テープ代が高い」「印刷が遅い」の2点で、月10枚使用で1日約16円のランニングコストがかかる。デザイン性と手軽さを評価する口コミが多い一方、業務用途やコスト重視層からは厳しい評判も。
