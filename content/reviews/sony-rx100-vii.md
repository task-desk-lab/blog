...
4K 30分以上録画すると本体が熱くなり自動停止することがある。特に夏場の屋外撮影やVlog撮影で発生しやすい。Sonyも仕様として明記しており、温度管理が必須。

だからこそ、動画撮影の用途が限定される人にとっては、気になる要素ではありません。

**ヘッドフォン端子がない**

モニタリング用のヘッドフォン端子が廃止されているため、動画撮影時に音声チェックができない。マイク入力はあるが出力がないため、Vloggerには不便な仕様だ。
...
競合である Canon PowerShot G7 X Mark III と比べると、Sony RX100 VII のほうが瞳AF と連写性能で上回る。一方、Canon 機はバッテリーが若干長持ちし、ホットシューがあるので外付けフラッシュが使える点が利点だ。
...
20fps連写と瞳AF により「決定的瞬間」を逃さないという満足感が大きい層。このユーザー層なら、他の機種には戻れなくなるはずだ。
