...
**プラグが折りたためない**  
コンセント部分が固定式で、収納時にバッグ内で他の物に引っかかりやすい。持ち運びを重視する人にとっては、この点だけが惜しい。ポーチに入れるなど対策が必要。

**USB-Aポートは18Wまで**  
USB-Aは最大18W（12V/1.5A）で、急速充電規格には非対応。iPhoneやAndroidスマホの急速充電にはUSB-Cポートを使う必要がある。USB-A機器を急速充電したい人には向かないという口コミがあった。

**重量が約130gでやや重い**  
軽量重視の人には物足りない。同等出力の単ポート充電器なら100g以下もあるため、3ポート要らないなら別の選択肢の方が軽い。
...
**コンパクトさと携帯性**  
65W出力で3ポート搭載ながら、手のひらサイズ。重量130gは軽くはないが、純正充電器3個（合計300g超）を持ち歩くより圧倒的に軽い。カフェ作業が多い人なら、バッグの定位置が決まる一品だ。

**Ankerの安心感と保証**  
18ヶ月保証付き。過去Anker製品を使って問題なかった経験から、信頼してリピート購入する層が一定数いた。初期不良時の対応も早いとの評判。

**純正より安くて多機能**  
Apple純正65W充電器は約9,800円で1ポートのみ。この充電器は5,490円で3ポート。コスパ面での満足度が高く、一度使うと純正に戻れなくなる。
